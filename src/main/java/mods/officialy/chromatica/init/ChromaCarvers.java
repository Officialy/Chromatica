...
public class ChromaCarvers {
    ...
    public static final DeferredRegister<ConfiguredWorldCarver<?>> CARVER_CONFIGURATIONS = DeferredRegister.create(Registries.CONFIGURED_CARVER, Chromatica.MOD_ID);
